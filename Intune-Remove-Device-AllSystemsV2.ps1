...
.SYNOPSIS
    Device Deletion Script V2 - Searches for computer records across Active Directory, Intune, EntraID, & Autopilot and deletes them.
...
.FUNCTIONALITY
    ...
    - Searches for and deletes devices across AD, Intune, EntraID, & Autopilot.
